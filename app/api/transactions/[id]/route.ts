    ...
    const result = await prisma.$transaction(async (prisma) => {
      ...
      const updatedTransaction = await prisma.transaction.update({
        ...
        data: {
          ...
          ...(validatedData.exchangeRate && { exchangeRate: new Decimal(validatedData.exchangeRate) }),
          ...(validatedData.baseCurrencyAmount && { baseCurrencyAmount: new Decimal(validatedData.baseCurrencyAmount) }),
