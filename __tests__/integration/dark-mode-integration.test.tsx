...
describe('Dark Mode Integration', () => {
  ...
  describe('Component Integration', () => {
    ...
    it('should have proper card styling with dark mode', () => {
      ...
      card.className =
        'rounded-lg border bg-card text-card-foreground shadow-sm dark:bg-gray-900 dark:border-gray-700'
    ...
    it('should handle form elements with proper dark mode styling', () => {
      ...
      input.className =
        'flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background cursor-text dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:placeholder-gray-400'
  ...
  describe('Typography and Colors', () => {
    ...
    it('should handle warning message colors in dark mode', () => {
      ...
      warning.className =
        'p-3 rounded-lg bg-yellow-50 border border-yellow-200 text-sm text-yellow-800 dark:bg-yellow-900/50 dark:border-yellow-600 dark:text-yellow-200'
