...
export function CurrencyConverter({
  ...
  // 為替レート取得
  const exchangeRate = fromCurrency && toCurrency && fromCurrency !== toCurrency
    ? exchangeManager.getRate(fromCurrency, toCurrency)
    : null
  
  // 逆レート
  const reverseRate = toCurrency && fromCurrency && fromCurrency !== toCurrency
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <div className="flex-1 p-3 rounded border bg-muted/50">
        ...
        {!exchangeRate && fromCurrency && toCurrency && fromCurrency !== toCurrency && (
          <div className="p-3 rounded border border-yellow-200 bg-yellow-50 text-sm text-yellow-800 dark:border-yellow-600 dark:bg-yellow-900/50 dark:text-yellow-200">
