...
import { CreditCard, Wallet, PiggyBank, Clock, Eye, EyeOff, Plus, Settings, Edit, Trash2, MoreHorizontal } from 'lucide-react'
...
export function AccountsList({
  ...
  const isNearMaturity = (account: typeof accounts[0]) => {
    ...
    const daysUntilMaturity = Math.ceil((maturity.getTime() - now.getTime()) / (1000 * 60 * 60 * 24))
      ...
      <CardContent>
        ...
        {accounts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium mb-2">口座がありません</h3>
            <p className="text-muted-foreground mb-4">
              最初の口座を作成して資産管理を始めましょう
            </p>
            {onCreateAccount && (
