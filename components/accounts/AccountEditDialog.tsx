...
const ACCOUNT_TYPES = [
  ...
  },
  {
    ...
    color: 'bg-green-50 border-green-200 text-green-700 dark:bg-green-900/50 dark:border-green-600 dark:text-green-200'
  },
  {
    value: 'CASH',
    label: '現金',
    ...
    color: 'bg-yellow-50 border-yellow-200 text-yellow-700 dark:bg-yellow-900/50 dark:border-yellow-600 dark:text-yellow-200'
  },
  {
    value: 'FIXED_DEPOSIT',
    label: '定期預金',
  ...
  const onSubmit = async (values: FormData) => {
    ...
    try {
      const result = await updateAccount(accountId, {
        ...
        fixedDepositMaturity: values.fixedDepositMaturity ? new Date(values.fixedDepositMaturity) : undefined,
